...
abstract class BuildSystem[Extractor, LocalBuildRunner] {
  ...
  def extractDependencies(config: ExtractionConfig, tracker: TrackedProcessBuilder,
    dir: java.io.File, extractor: Extractor, log: Logger, debug: Boolean): ExtractedBuildMeta
  /**
   ...
   */
  def runBuild(project: RepeatableProjectBuild, tracker: TrackedProcessBuilder, dir: java.io.File,
