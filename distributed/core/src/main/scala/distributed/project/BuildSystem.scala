...
abstract class BuildSystem[Extractor, LocalBuildRunner] {
   ...
   */
  def runBuild(project: RepeatableProjectBuild, dir: java.io.File, info: BuildInput, localBuildRunner: LocalBuildRunner, log: logging.Logger): BuildArtifactsOut
...
object BuildSystem {
   ...
   */
  def expandDistributedBuildConfig[A, B](build: DistributedBuildConfig, systems: Seq[BuildSystem[A, B]]) = {
