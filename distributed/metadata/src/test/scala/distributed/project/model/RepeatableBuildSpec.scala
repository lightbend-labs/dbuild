  ...
  "RepeatableDistributedBuild" should {
    ...
    val sample = RepeatableDistributedBuild(Seq(
          ProjectConfigAndExtracted(
              ...
              ExtractedBuildMeta("0.1", Seq(ProjMeta(
                  Seq(Project(
                    name = "a",
                    organization = "a",
          ...
          ProjectConfigAndExtracted(
              ...
              ExtractedBuildMeta("0.1-test1", Seq(ProjMeta(
                  Seq(Project(
                    name = "b",
                    organization = "b",
         ...
         ProjectConfigAndExtracted(
              ...
              ExtractedBuildMeta("0.1-beta1", Seq(ProjMeta(
                  Seq(Project(
                    name = "d",
                    organization = "d",
        ...
        ProjectConfigAndExtracted(
              ...
              ExtractedBuildMeta("3.0", Seq(ProjMeta(
                  Seq(Project(
                    name = "e",
                    organization = "e",
