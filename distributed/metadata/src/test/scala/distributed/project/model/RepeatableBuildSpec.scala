  ...
  "RepeatableDistributedBuild" should {
    ...
    val sample = RepeatableDistributedBuild(Seq(
          ProjectConfigAndExtracted(
              ProjectBuildConfig("a", "scala", "uri", None, None, None, None, None),
          ...
          ProjectConfigAndExtracted(
              ProjectBuildConfig("b", "scala", "uri2", Some("2.0"), None, None, None, None),
         ...
         ProjectConfigAndExtracted(
              ProjectBuildConfig("c", "scala", "uri3", None, None, None, None, None),
              ExtractedBuildMeta("0.1",
                  Seq(Project(
                    name = "c",
                    organization = "c",
         ...
         ProjectConfigAndExtracted(
              ProjectBuildConfig("d", "scala", "uri4", None, None, None, None, None),
        ...
        ProjectConfigAndExtracted(
              ProjectBuildConfig("e", "scala", "uri5", None, None, None, None, None),
