...
trait BuildSystem {
   ...
   */
  def extractDependencies(config: BuildConfig, dir: java.io.File, log: Logger): ExtractedBuildMeta
  /**
   ...
   */
  def runBuild(project: Build, dir: java.io.File, dependencies: BuildArtifacts, log: logging.Logger): BuildArtifacts
}