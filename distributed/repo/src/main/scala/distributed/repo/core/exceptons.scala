...
case class ResolveException(key: String, msg: String) extends java.lang.RuntimeException(msg) with RepositoryException {
  override def toString = "ResolveException(" + key + ", " + msg + ")"
}
case class TraversalException(key: String, msg: String) extends java.lang.RuntimeException(msg) with RepositoryException
