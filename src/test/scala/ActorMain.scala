...
object ActorMain {
  ...
  def scalatest =
    BuildConfig("scalatest", "sbt", "http://scalatest.googlecode.com/svn/trunk", "")
  ...
  def dBuildConfig =
    DistributedBuildConfig(Seq(scalatest, /*specs2,*/ scalacheck, /*scalaIo,*/ scalaConfig, scalaArm, sperformance, specs2scalaz))
